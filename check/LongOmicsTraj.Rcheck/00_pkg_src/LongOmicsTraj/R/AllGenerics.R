...
#' Compare LongOmicsTraj results
#'
#' Compares trajectory or topology results stored in a `LongOmicsTraj`
#' object.
#'
#' @param object A `LongOmicsTraj` object.
#' @param ... Additional comparison arguments passed to the corresponding
#' method.
#'
...
#' Visualise LongOmicsTraj results
#'
#' Creates visual summaries of molecular trajectories and related analysis
#' results.
#'
#' @param object A `LongOmicsTraj` object.
#' @param ... Additional plotting arguments passed to the corresponding
#' method.
#'
